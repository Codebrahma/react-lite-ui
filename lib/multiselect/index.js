...
class MultiSelect extends Component {
  ...
  getScrollState = () => {
    const threshold = findNode(this.listRef).offsetTop
  ...
  */
  toggleMenu = () => {
    const { blockClickEvent } = this.state;
    if (!blockClickEvent) {
    ...
    return (
      <div className={classes}>
        ...
        >
          ...
          <FaAngleUp className={cx(theme.arrow, open ? theme.up : theme.down)} />
        </div>
        {open && (
          <div
            id="dropdown-options"
