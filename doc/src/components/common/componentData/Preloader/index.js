        ...
        return (
          <div>
            ...
            <PreviewBlock header="Default Preloader (size, color)">
              ...
              {/* Default preloader with different sizes and colors */}
                <span>
                  small, danger
            ...
            <PreviewBlock header="Preloader with dots (size, color)">
              ...
              {/* Dots preloader with different sizes and colors */}
                <span>
                  small, warning
            ...
            <PreviewBlock header="Preloader with fade-away effect (size, color)">
              ...
              {/* fadeaway preloader with different sizes and colors */}
              <span>
                small, success
            ...
            <PreviewBlock header="Preloader with lines (size, color)">
              ...
              {/* Lines preloader with different sizes and colors */}
              <span>
                small, primary
            ...
            <PreviewBlock header="Preloader with color circle (size, color)">
              ...
              {/* colorCircles preloader with different sizes and colors */}
              <span>
                small, secondary
