  ...
  <StaticQuery
    ...
    render={data => (
      <React.Fragment>
        ...
        <Navbar theme={theme} className={`navbar${window.location.pathname !== '/' ? ' navbar-extended' : ''}`} position="fixed" flat title={<Link to="/">React Lite UI</Link>} leftIcon={<Link to="/"><img src={liteLogo} alt="navbar-left-logo" /></Link>}>
